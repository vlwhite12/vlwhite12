...
|---|---|---|
| [PhishCatch AI](https://github.com/vlwhite12/phishcatch) | Python, FastAPI, Next.js, TypeScript, Ollama, Chrome Extension (MV3) | Full-stack AI phishing detector with local LLM inference, JWT auth, prompt injection defenses, and a Gmail Chrome extension |
